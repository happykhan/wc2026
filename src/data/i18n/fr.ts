export const fr = {
  ...
  spoilerBannerOff: 'Les spoilers sont désactivés. Activez-les dans l\'en-tête pour voir les points et les classements en direct.',
  spoilerEnableHint: 'Activez les spoilers pour voir le classement en direct',
  vs: 'vs',
