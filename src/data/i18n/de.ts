export const de = {
  ...
  spoilerBannerOff: 'Spoiler sind deaktiviert. Aktivieren Sie sie in der Kopfzeile, um Live-Punkte und Tabellen zu sehen.',
  spoilerEnableHint: 'Spoiler aktivieren, um die Tabelle zu sehen',
  vs: 'vs',
